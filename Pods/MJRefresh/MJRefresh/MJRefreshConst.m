...
NSString *const MJRefreshAutoFooterNoMoreDataText = @"没有更多了...";

NSString *const MJRefreshBackFooterIdleText = @"加载更多";
NSString *const MJRefreshBackFooterPullingText = @"松开立即加载更多";
NSString *const MJRefreshBackFooterRefreshingText = @"正在加载更多的数据...";
NSString *const MJRefreshBackFooterNoMoreDataText = @"没有更多商家了...";